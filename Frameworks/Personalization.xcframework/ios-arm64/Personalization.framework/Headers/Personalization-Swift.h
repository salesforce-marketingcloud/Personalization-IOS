...
@class NSString;
/// Represents the information needed to retrieve data for a Personalization Experience Config
SWIFT_CLASS_NAMED("DataProvider")
@interface SFPDataProvider : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull value;
@property (nonatomic, readonly, copy) NSString * _Nullable groupByValue;
- (nonnull instancetype)initWithValue:(NSString * _Nonnull)value groupByValue:(NSString * _Nullable)groupByValue;
...
@property (nonatomic, readonly, copy) NSString * _Nullable anchorDmoName SWIFT_DEPRECATED_MSG("Use anchorType instead");
/// The anchor type identifier.
/// Specifies the type or category of the anchor entity. This replaces the deprecated
/// <code>anchorDmoName</code> property with clearer naming.
@property (nonatomic, readonly, copy) NSString * _Nullable anchorType;
...
/// If you provide this, you may wish to also provide the <code>anchorType(_:)</code>
...
/// @return This builder instance
- (SFPDecisionsRequestContextBuilder * _Nonnull)anchorDmoName:(NSString * _Nullable)aDmoName SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Use anchorType(_:) instead");
/// Sets the optional anchor type identifier for an optionally provided <code>anchorId(_:)</code>
/// @return This builder instance
- (SFPDecisionsRequestContextBuilder * _Nonnull)anchorType:(NSString * _Nullable)aType SWIFT_WARN_UNUSED_RESULT;
...
///
/// \endcode
@property (nonatomic, readonly, copy) NSDictionary<NSString *, SFPDecisionsResponsePersonalization *> * _Nonnull personalizationsByName;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Optional location of the CDN File for Server App Config with a Personalization section containing Transformers and PECs
@property (nonatomic, readonly, copy) NSString * _Nullable cdnUrl;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("Use the Builder to create an instance.");
...
/// Optional cdnUrl to use, otherwise does not retrieve Server App Config
- (SFPersonalizationConfigBuilder * _Nonnull)cdnUrl:(NSString * _Nullable)url SWIFT_WARN_UNUSED_RESULT;
...
@class SFPTransformationConfig;
/// A way of personalizing something in the Website or Mobile Application
SWIFT_CLASS_NAMED("PersonalizationExperienceConfig")
@interface SFPersonalizationExperienceConfig : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly, strong) SFPDataProvider * _Nullable dataProvider;
@property (nonatomic, readonly, strong) SFPTransformationConfig * _Nonnull transformationConfig;
@property (nonatomic, readonly, copy) NSDate * _Nullable lastModifiedDate;
@property (nonatomic, readonly, copy) NSDate * _Nullable publishedDate;
@property (nonatomic, readonly) BOOL isEnabled;
- (nonnull instancetype)initWithName:(NSString * _Nonnull)name dataProvider:(SFPDataProvider * _Nullable)dataProvider transformationConfig:(SFPTransformationConfig * _Nonnull)transformationConfig isEnabled:(BOOL)isEnabled publishedDate:(NSDate * _Nullable)publishedDate lastModifiedDate:(NSDate * _Nullable)lastModifiedDate OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///     \endcode</li>
///   <li>
///     Requesting personalizations/decisions, see <code>fetchDecisions(personalizationPointNames:decisionsRequestContext:timeoutSeconds:)</code>
///   </li>
/// </ul>
...
/// Fetch personalization decisions for the provided Personalization Points and optional <code>DecisionsRequestContext</code>.
...
///
/// \param decisionsRequestContext Optional <code>DecisionsRequestContext</code> to provide more info.
///
...
+ (void)fetchDecisionsWithPersonalizationPointNames:(NSArray<NSString *> * _Nonnull)personalizationPointNames decisionsRequestContext:(SFPDecisionsRequestContext * _Nullable)decisionsRequestContext timeoutSeconds:(NSTimeInterval)timeoutSeconds completionHandler:(void (^ _Nonnull)(SFPDecisionsResponse * _Nullable, NSError * _Nullable))completionHandler;
/// Variant of <code>fetchDecisions(personalizationPointNames:decisionsRequestContext:timeoutSeconds:)</code> without timeout,
...
/// Grouping personalization point names by datagraph is the responsibility of the caller.
/// This method does not automatically group or separate requests based on datagraph configuration.
+ (void)fetchDecisionsWithPersonalizationPointNames:(NSArray<NSString *> * _Nonnull)personalizationPointNames decisionsRequestContext:(SFPDecisionsRequestContext * _Nullable)decisionsRequestContext completionHandler:(void (^ _Nonnull)(SFPDecisionsResponse * _Nullable, NSError * _Nullable))completionHandler;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Represents different Configuration Types for Substitution Definitions of Personalization Transformers (aka Personalization Templates)
/// For SubDefNamingRules, see: https://gitcore.soma.salesforce.com/core-2206/core-260-public/blob/p4/260-patch/core/p13n-impl/java/src/p13n/udd/externalapp/mappers/SubDefNamingRules.md
typedef SWIFT_ENUM_NAMED(NSInteger, SFPSubDefConfigType, "SubDefConfigType", open) {
  SFPSubDefConfigTypeSchemaPath = 0,
  SFPSubDefConfigTypeStaticValue = 1,
};

/// A specific instance of converting data using a specific Personalization Transformer into something personalized for the Website or Mobile Application
SWIFT_CLASS_NAMED("Transformation")
@interface SFPTransformation : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull transformerName;
@property (nonatomic, readonly, copy) NSString * _Nullable name;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull substitutionValues;
- (nonnull instancetype)initWithTransformerName:(NSString * _Nonnull)transformerName substitutionValues:(NSDictionary<NSString *, NSString *> * _Nonnull)substitutionValues name:(NSString * _Nullable)name OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Describes how the data provided will be transformed into personalized content for a Personalization Experience Config.
SWIFT_CLASS_NAMED("TransformationConfig")
@interface SFPTransformationConfig : NSObject
@property (nonatomic, readonly, copy) NSArray<SFPTransformation *> * _Nonnull transformations;
- (nonnull instancetype)initWithTransformations:(NSArray<SFPTransformation *> * _Nonnull)transformations;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Describes a particular Substitution Variable that can be present for a Personalization Transformer (aka Personalization Template).
SWIFT_CLASS_NAMED("TransformerSubDef")
@interface SFPTransformerSubDef : NSObject
@property (nonatomic, readonly, copy) NSString * _Nullable defaultValue;
@property (nonatomic, readonly) enum SFPSubDefConfigType configType;
@property (nonatomic, readonly) BOOL isOverridable;
@property (nonatomic, readonly) BOOL isRequired;
- (nonnull instancetype)initWithConfigType:(enum SFPSubDefConfigType)configType defaultValue:(NSString * _Nullable)defaultValue isOverridable:(BOOL)isOverridable isRequired:(BOOL)isRequired OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Details for a specific type of Personalization Transformer (aka Personalization Template).
SWIFT_CLASS_NAMED("TransformerTypeDetails")
@interface SFPTransTypeDetails : NSObject
@property (nonatomic, readonly, copy) NSString * _Nullable componentName;
- (nonnull instancetype)initWithComponentName:(NSString * _Nullable)componentName OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
